...
all_data = pd.read_excel(r"/Users/satchy/Developer/ENSF592/labs/592P23LabExercises/Lab 8/WeatherData.xlsx", usecols = [2,5,6,7,8,9,10], index_col = [0,1,2,3])

all_data.to_excel(r"/Users/satchy/Developer/ENSF592/labs/592P23LabExercises/Lab 8/WeatherData.xlsx", index = True, header = True)
