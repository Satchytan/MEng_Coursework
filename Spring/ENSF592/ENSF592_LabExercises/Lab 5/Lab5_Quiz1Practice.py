...
def main():
    ...
    horse4 = Horse("Harry", 11, "grey", "Quarter Horse")
    horse5 = Horse("Lightning", 14, "brown", "Quarter Horse")
    ...
    all_ages = set(horse_ages).union(set(rider_ages))
    ...
    regex = re.compile('\w*[ALal]\w*[ALal]\w*')
